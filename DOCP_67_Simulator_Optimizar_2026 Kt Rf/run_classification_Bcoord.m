function [halfSm2,S,Sx,Mx,fl,nlf,Co,Tix,Tq,index,nr,Iq,Ipback,Ipq,Ipp,Ii,Ij,Iip,Ijp,Ipi,Ipj,CaseType,distance,Bcoord,Bcoord_case] =  run_classification_Bcoord(x,ncase,reply2,nlf,D,Ip,K)
global loadsflag Dmin Co nr reply2 bdat ldat K Ip Sbase Vbase Zbase Ibase econv itermax tdat nlf qmax lowerbound upperbound npr reversest linenumber back main dictiolines dictiorelays
%halfSm2=[];S=[];Sx=[];Bcoord=[];Bcoord_case=[];
